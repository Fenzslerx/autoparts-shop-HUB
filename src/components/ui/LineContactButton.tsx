...
export default function LineContactButton({
    ...
    // Create the message to send via LINE
    const message = encodeURIComponent(
        `สนใจสินค้า: ${productName}${price ? ` (ราคา: ${price.toLocaleString()} บาท)` : ''}\nรหัสสินค้า: ${productId}\n\nขอสอบถามรายละเอียดเพิ่มเติมครับ/ค่ะ`
    );
    ...
    return (
      ...
      `}
        >
            ...
            <span>ติดต่อสั่งซื้อผ่าน LINE</span>
        </a>
    );
}
