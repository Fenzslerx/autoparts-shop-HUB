                ...
                <div className="flex items-center justify-between h-16">
                    ...
                    <div className="hidden lg:flex items-center gap-3">
                        ...
                        <Link
                            ...
                            target="_blank"
                            className="flex items-center gap-2 px-5 py-2.5 rounded-full bg-gradient-to-r from-blue-600 to-blue-500 text-white font-bold hover:from-blue-700 hover:to-blue-600 transition-all hover:scale-105 shadow-lg shadow-blue-500/30"
                        >
                            <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
                                <path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z" />
                            </svg>
                            <span>Facebook</span>
                            <span className="px-2 py-0.5 bg-white/20 rounded-full text-xs">ช่องทางหลัก</span>
                        </Link>
                        <Link
                ...
                `}>
                    <div className="container mx-auto px-4 py-8 flex flex-col gap-3 max-h-[85vh] overflow-y-auto">
                        ...
                        <Link
                            ...
                            onClick={() => setIsMenuOpen(false)}
                        >
                            <span className="text-xl">FB</span> Facebook Feed
                        </Link>
