                ...
                <div className="max-w-4xl mx-auto px-4">
                    ...
                    <div className="grid md:grid-cols-3 gap-8 text-center">
                        ...
                        <div className="p-6">
                            ...
                            <a href="https://line.me/ti/p/~0890071802" target="_blank" className="text-[#06C755] font-medium hover:underline">0890071802</a>
                        </div>
                    </div>
                </div>
            </section>
            ...
            <section className="py-16 gradient-hero text-white text-center">
                <div className="max-w-2xl mx-auto px-4">
                    ...
                    <div className="flex flex-col sm:flex-row gap-4 justify-center">
                        ...
                        <a href="https://line.me/ti/p/~0890071802" target="_blank" className="btn-line">
                            💬 ติดต่อทาง LINE
                        </a>
                    </div>
                </div>
